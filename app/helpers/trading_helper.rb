  ...
  def transaction_button(item ,saler_user,  buyer_user)
    ...
    when saler_user
      case item.trading_status_id
        ...
        when 3
          link_to "取引を完了する", item_trading_path(item, current_user), method: :patch, class: "content__trading__box__btn", remote: true,data: { confirm: '取引を完了してよろしいですか?',cancel: 'やめる',commit: '完了する', disable_with: "処理中..." }, title: '取引確認'
        when 5
    ...
    when buyer_user
      case item.trading_status_id
        when 2
          link_to "受け取り評価完了", item_trading_path(item, current_user), method: :patch, class: "content__trading__box__btn", remote: true, data: { confirm: '受け取り評価を完了してよろしいですか?',cancel: 'やめる',commit: '完了する', disable_with: "処理中..." }, title: '取引確認'
        when 5
          "取引は完了しました"
        when 7
          link_to "取引キャンセルを承認する", cancel_item_trading_path(item, current_user), method: :patch, class: "content__trading__box__btn", remote: true, data: { confirm: '取引キャンセルを承認してよろしいですか?',cancel: 'やめる',commit: '承認する', disable_with: "処理中..." }, title: '承認確認'
